...
public class Inicio extends World
{
        ...
        GreenfootSound musicaFondo = new GreenfootSound ("musica inicio.mp3");
    ...
    {    
        ...
        addObject(new ConstructorTerran(),913,277);
        addObject(new ConstructorZerg(),338,312);
        addObject(new GuerreroTerran (),950, 295);
        addObject(new GuerreroZerg(), 400,400);
    ...
    private void prepare()
    {
        ...
        Roca1 roca9 = new Roca1();
        addObject(roca9,622,315);
    }
}
